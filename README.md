...
To install, just download qattitude.zip from the latest release, then in QGis > Plugins > Manage and Install Plugins > Install from ZIP > select qattitude.zip > Install Plugin > Yes > Close, and you will find qAttitude in the Plugins menu and toolbar.