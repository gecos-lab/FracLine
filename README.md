...
To install, just download [qattitude.zip](https://github.com/gecos-lab/FracLine/releases/latest/download/fracline.zip) from the latest release, then in QGis > Plugins > Manage and Install Plugins > Install from ZIP > select qattitude.zip > Install Plugin > Yes > Close, and you will find qAttitude in the Plugins menu and toolbar.
